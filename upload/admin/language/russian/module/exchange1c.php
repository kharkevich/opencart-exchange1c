...
//Экспорт заказов в 1С с характеристиками (опциями)
$_['export_orders_to_1c_with_option']	= 'Выгружать заказы в 1С с опциями товаров';
$_['export_orders_to_1c_with_option_help']	= 'Эксперементальный функционал! Если флажок установлен - при выгрузке в 1С ко всем товарам будут прикреплятся опции (характеристики в 1С УТ)';
