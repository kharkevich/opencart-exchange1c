...
$_['entry_delimiter'] = 'Clear product options:';
$_['entry_delimiter_help'] = 'Delete all after symbols in form, in product options, if they imported as "Option(Category(Catalogue)" ';
